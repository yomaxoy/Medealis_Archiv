    ...
    def determine_manufacturer(self, article_number: str) -> str:
        ...
        for prefix in sorted_prefixes:
            if article_upper.startswith(prefix):
                ...
                logger.debug(f"Article {article_number} mapped to manufacturer: {manufacturer}")
                return manufacturer

        # Default fallback
        logger.debug(f"Article {article_number} using default manufacturer: Standard_Implantate")
